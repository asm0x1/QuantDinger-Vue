...
const locale = {
  ...
  "trading-assistant.notify.bark": "Bark",
  ...
  "profile.notifications.barkSection": "Bark Push (iOS)",
  "profile.notifications.barkDeviceKey": "Bark Device Key",
  "profile.notifications.barkDeviceKeyPlaceholder": "Get Device Key from Bark App",
  "profile.notifications.barkDeviceKeyHint": "Get from the Bark App on iOS to receive push notifications",
  "profile.notifications.barkServerUrl": "Bark Server URL",
  "profile.notifications.barkServerUrlPlaceholder": "https://api.day.app",
  "profile.notifications.barkServerUrlHint": "Defaults to https://api.day.app; enter your self-hosted server URL if applicable",
  "profile.notifications.barkCustomParams": "Custom Parameters",
  "profile.notifications.barkCustomParamsPlaceholder": "e.g. {\"url\":\"https://...\"}",
  "profile.notifications.barkCustomParamsHint": "JSON format. Optional fields: url (click-through link), icon (notification icon), level (urgency: active/timeSensitive/passive), isArchive (auto-archive), sound (ringtone), group (grouping)",
  "profile.notifications.fillBark": "Please fill in Bark Device Key",
